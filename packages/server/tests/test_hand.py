...
class TestBlinds:
    def test_blinds_posted(self):
        ...
        hand = Hand(players, dealer_index=0, deck_seed_hex="01")
...
class TestSidePots:
    def test_side_pot_with_unequal_stacks(self):
        ...
        hand = Hand([p1, p2, p3], dealer_index=0, deck_seed_hex="2a")
...
class TestFullHand:
    def test_full_hand_to_showdown(self):
        players = make_players(2, chips=1000)
        hand = Hand(players, dealer_index=0, deck_seed_hex="2a")
...
class TestActionIdAndTimestamp:
    ...
    def test_starting_action_id_offset(self):
        players = make_players(2)
        hand = Hand(players, dealer_index=0, deck_seed_hex="01", starting_action_id=100)
        ids = [a.id for a in hand.actions]

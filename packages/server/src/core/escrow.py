...
def sign_create_escrow(
    ...
    The factory verifies this signature before deploying a new escrow proxy.
    Domain: name="EscrowFactory", version="1", verifyingContract=factory_address.
    ...
    *,
    ...
    Args:
        pcr0: Raw PCR-0 value (48 bytes when inside enclave, empty otherwise).
              Included in the EIP-712 signed message for on-chain verification.

...
export function WinnerOverlay({
  ...
  return (
    ...
    >
      <div
        className="rounded-2xl border-2 border-dealer-gold bg-gradient-to-br from-[#1a1a2e] to-[#16213e] px-16 py-10 text-center shadow-[0_0_40px_rgba(212,168,67,.3)]"
        style={{ animation: "scale-in 0.4s cubic-bezier(.34,1.56,.64,1)" }}
      >
        <div className="mb-2 text-xs uppercase tracking-[3px] text-sage">
          Winner
        </div>
        <div
          className="text-4xl font-bold text-dealer-gold"
